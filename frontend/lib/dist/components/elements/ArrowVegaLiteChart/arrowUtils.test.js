...
import { CATEGORICAL, DATE, DATETIME, DATETIMETZ, FLOAT64, INT64, RANGE, UINT64, UNICODE } from "../../../mocks/arrow";
  ...
  describe("Supported", () => {
    test("datetimetz", () => {
      ...
      expect(getDataArray(q)).toEqual([{
        "(index)": 978220800000,
        "2000-12-31 00:00:00": new Date("2020-01-02T05:00:00.000Z").valueOf(),
        "2001-12-31 00:00:00": new Date("2020-10-20T05:00:00.000Z").valueOf()
      }, {
        "(index)": 1009756800000,
        "2000-12-31 00:00:00": new Date("2020-01-02T05:00:00.000Z").valueOf(),
        "2001-12-31 00:00:00": new Date("2020-10-20T05:00:00.000Z").valueOf()
