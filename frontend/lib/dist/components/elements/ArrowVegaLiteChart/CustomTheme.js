...
import { getCategoricalColorsArray, getDivergingColorsArray, getGray30, getGray70, getSequentialColorsArray, hasLightBackgroundColor } from "../../../theme";
export function applyStreamlitTheme(config, theme) {
  ...
  return mergeWith({}, streamlitTheme, config, (_, b) => Array.isArray(b) ? b : undefined);
}
export function applyThemeDefaults(config, theme) {
  const {
    colors,
    fontSizes,
    genericFonts
