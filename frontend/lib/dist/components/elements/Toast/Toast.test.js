...
import { shortenMessage, Toast } from "./Toast";
...
describe("Toast Component", () => {
  ...
  test("shortenMessage truncates messages over the character limit without cutting words", () => {
    ...
    const toastText = screen.getByRole("alert")?.textContent?.replace("view moreClose", "");
  ...
  test("expands and collapses long messages with explicit line breaks correctly", () => {
    ...
    const toastExpanded = screen.getByRole("alert")?.textContent?.replace("view lessClose", "");
    ...
    const toastCollapsed = screen.getByRole("alert")?.textContent?.replace("view moreClose", "");
