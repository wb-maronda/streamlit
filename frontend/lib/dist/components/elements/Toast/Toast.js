...
import { StyledViewButton, StyledToastWrapper, StyledMessageWrapper } from "./styled-components";
  ...
  return {
    ...
    CloseIcon: {
      style: {
        ...
        marginRight: "calc(-1 * ".concat(theme.spacing.lg, " / 2)"),
        ":hover": {
          color: theme.colors.bodyText
        }
      }
...
export function Toast(_ref) {
  ...
  const toastContent = useMemo(() => /*#__PURE__*/_jsx(_Fragment, {
    children: /*#__PURE__*/_jsxs(StyledToastWrapper, {
      expanded: expanded,
