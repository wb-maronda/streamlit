...
import { DynamicIcon, StyledSpinnerIcon, StyledIcon } from "../../shared/Icon";
...
import { BORDER_SIZE, StyledExpandableContainer, StyledSummary, StyledSummaryHeading, StyledDetailsPanel, StyledDetails } from "./styled-components";
...
const Expander = _ref => {
  ...
  const toggle = e => {
    ...
    if (!expanded) {
      detailsEl.style.height = "".concat(detailsHeight, "px");
      detailsEl.open = true;
