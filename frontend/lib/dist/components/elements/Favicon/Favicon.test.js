...
const PIZZA_TWEMOJI_URL = "https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f355.png";
const SATELLITE_TWEMOJI_URL = "https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f6f0.png";
const CRESCENT_MOON_TWEMOJI_URL = "https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f319.png";
const FLAG_MATERIAL_ICON_URL = "https://fonts.gstatic.com/s/i/short-term/release/materialsymbolsoutlined/flag/default/24px.svg";
const SMART_DISPLAY_MATERIAL_ICON_URL = "https://fonts.gstatic.com/s/i/short-term/release/materialsymbolsoutlined/smart_display/default/24px.svg";
const ACCESSIBILITY_NEW_MATERIAL_ICON_URL = "https://fonts.gstatic.com/s/i/short-term/release/materialsymbolsoutlined/accessibility_new/default/24px.svg";
...
describe("Favicon element", () => {
  ...
  it("sets the favicon in the DOM", () => {
    ...
    expect(buildMediaURL).toHaveBeenCalledWith("https://some/random/favicon.png");
  ...
  it("sends SET_PAGE_FAVICON message to host", () => {
    ...
    handleFavicon("https://streamlit.io/path/to/favicon.png", sendMessageToHost, endpoints);
