...
import { StyledChatMessageContainer, StyledMessageContent, StyledAvatarImage, StyledAvatarIcon, StyledAvatarBackground } from "./styled-components";
...
const ChatMessage = _ref => {
  ...
  return /*#__PURE__*/_jsxs(StyledChatMessageContainer, {
    ...
    children: [/*#__PURE__*/_jsx(ChatMessageAvatar, {
      ...
      "aria-label": "Chat message from ".concat(name),
      children: children
    })]
  });
};
