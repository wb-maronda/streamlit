...
import "../../../vendor/bokeh/bokeh-api-2.4.3.esm.min";
import "../../../vendor/bokeh/bokeh-gl-2.4.3.esm.min";
import "../../../vendor/bokeh/bokeh-mathjax-2.4.3.esm.min";
import "../../../vendor/bokeh/bokeh-tables-2.4.3.esm.min";
import "../../../vendor/bokeh/bokeh-widgets-2.4.3.esm.min";
import { jsx as _jsx } from "react/jsx-runtime";
export function BokehChart(_ref) {
  let {
    width,
    element,
    height
  } = _ref;
  const chartId = "bokeh-chart-".concat(element.elementId);
  const memoizedGetChartData = useCallback(() => {
    return JSON.parse(element.figure);
  }, [element]);
  const getChartDimensions = useCallback(plot => {
    // Default values
  ...
  const memoizedUpdateChart = useCallback(updateChart, [chartId, getChartDimensions]);
...
//# sourceMappingURL=BokehChart.js.map