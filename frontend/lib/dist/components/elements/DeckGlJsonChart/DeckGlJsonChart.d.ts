...
export declare class DeckGlJsonChart extends PureComponent<PropsWithHeight, State> {
    ...
    static getDeckObject: (props: PropsWithHeight, state: Partial<State>) => DeckObject;
...
declare const _default: React.FC<Pick<Omit<{
    ...
    element: DeckGlJsonChartProto;
    width: number;
}, "element" | keyof import("../../shared/FullScreenWrapper/withFullScreenWrapper").Props> & {
