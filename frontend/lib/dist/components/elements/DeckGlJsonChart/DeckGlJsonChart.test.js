...
describe("DeckGlJsonChart element", () => {
  ...
  describe("createTooltip", () => {
    let deckGlInstance;
    beforeEach(() => {
      deckGlInstance = new DeckGlJsonChart({
        ...getProps()
      });
    });
  ...
  describe("getDeckObject", () => {
    ...
    const testJsonParsing = (description, stateOverride) => {
    ...
    testJsonParsing("should call JSON5.parse when the element id is different", {
      id: newId
    });
