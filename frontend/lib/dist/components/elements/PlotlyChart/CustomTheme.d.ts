 ...
 */
export declare function applyStreamlitThemeTemplateLayout(layout: any, theme: EmotionTheme): void;
export declare function replaceTemporaryColors(spec: string, theme: EmotionTheme, elementTheme: string): string;
/**
 ...
 * @param spec - spec
 */
export declare function applyStreamlitTheme(spec: any, theme: EmotionTheme): void;
/**
 ...
 */
export declare function layoutWithThemeDefaults(layout: any, theme: EmotionTheme): any;
