...
export function PlotlyChart(_ref) {
  ...
  // width in this case.
  plotlyFigure.layout?.width : Math.max(element.useContainerWidth ? width : Math.min(initialFigureSpec.layout.width ?? width, width),
  ...
  useEffect(() => {
    ...
    let clickmode;
    if (plotlyFigure.layout?.dragmode === "select" || plotlyFigure.layout?.dragmode === "lasso") {
      clickmode = "event";
    } else {
  ...
  return /*#__PURE__*/_jsx("div", {
    ...
    children: /*#__PURE__*/_jsx(Plot, {
      ...
      style: {
        ...
        visibility: plotlyFigure.layout?.width === undefined ? "hidden" : undefined
      },
