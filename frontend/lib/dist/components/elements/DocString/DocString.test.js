...
import DocString, { Member } from "./DocString";
...
describe("DocString Element", () => {
  ...
  it("renders without crashing", () => {
    render( /*#__PURE__*/_jsx(DocString, {
      ...props
    }));
  ...
  it("should render a doc-string", () => {
    ...
    expect(screen.getByTestId("stHelpDoc")).toHaveTextContent(props.element.docString);
  });
  it("should render 'no docs' text when empty", () => {
    ...
    expect(screen.getByTestId("stHelpDoc")).toHaveTextContent("No docs available");
  });
  describe("doc-header", () => {
    ...
    it("should render value", () => {
      ...
      expect(screen.getByTestId("stHelpValue")).toHaveTextContent("streamlit.balloons()");
    });
  ...
  describe("members table", () => {
    it("should render no members when there are none", () => {
      ...
      expect(screen.queryByTestId("stHelpMembersTable")).not.toBeInTheDocument();
    });
...
describe("Member Element", () => {
  it("should render value-oriented members", () => {
    ...
    render( /*#__PURE__*/_jsx(Member, {
      ...props
    }));
    expect(screen.getByTestId("stHelpMemberDocValue")).toHaveTextContent("value1");
    expect(screen.getByTestId("stHelpMemberDocName")).toHaveTextContent("member1");
    expect(screen.getByTestId("stHelpMemberDocType")).toHaveTextContent("type1");
  });
  it("should render doc-oriented members", () => {
    ...
    expect(screen.getByTestId("stHelpMemberDocName")).toHaveTextContent("member1");
    expect(screen.getByTestId("stHelpMemberDocType")).toHaveTextContent("type1");
    expect(screen.getByTestId("stHelpMemberDocString")).toHaveTextContent("docstring1");
  });
  it("should prefer value over doc", () => {
    ...
    expect(screen.getByTestId("stHelpMemberDocName")).toHaveTextContent("member1");
    expect(screen.getByTestId("stHelpMemberDocType")).toHaveTextContent("type1");
    expect(screen.queryByTestId("stHelpMemberDocString")).not.toBeInTheDocument();
  ...
  it("should tell you when there are no docs", () => {
    ...
    expect(screen.getByTestId("stHelpMemberDocString")).toHaveTextContent("No docs available");
  });
...
//# sourceMappingURL=DocString.test.js.map