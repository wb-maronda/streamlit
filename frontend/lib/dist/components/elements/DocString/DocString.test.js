...
describe("DocString Element", () => {
  ...
  it("should render a doc-string", () => {
    ...
    expect(screen.getByTestId("stDocstring-Doc")).toHaveTextContent(props.element.docString);
  });
  it("should render 'no docs' text when empty", () => {
    ...
    expect(screen.getByTestId("stDocstring-Doc")).toHaveTextContent("No docs available");
  });
  describe("doc-header", () => {
    it("should render a name", () => {
      ...
      expect(screen.getByTestId("stDocstringName")).toHaveTextContent("st.balloons");
    });
    it("should render value", () => {
      render( /*#__PURE__*/_jsx(DocString, {
        ...props
      }));
      expect(screen.getByTestId("stDocstringValue")).toHaveTextContent("streamlit.balloons()");
    });
  ...
  describe("members table", () => {
    it("should render no members when there are none", () => {
      ...
      expect(screen.queryByTestId("stDocstringMembersTable")).not.toBeInTheDocument();
    });
...
describe("Member Element", () => {
  ...
  it("should render doc-oriented members", () => {
    ...
    expect(screen.getByTestId("stMemberDocName")).toHaveTextContent("member1");
    expect(screen.getByTestId("stMemberDocType")).toHaveTextContent("type1");
    expect(screen.getByTestId("stMemberDocString")).toHaveTextContent("docstring1");
  });
  ...
  it("should tell you when there are no docs", () => {
    ...
    expect(screen.getByTestId("stMemberDocString")).toHaveTextContent("No docs available");
  });
