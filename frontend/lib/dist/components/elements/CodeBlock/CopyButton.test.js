...
describe("CopyButton Element", () => {
  ...
  describe("attributes", () => {
    it("should have title", () => {
      ...
      expect(screen.getByTestId("stCopyButton")).toHaveAttribute("title", "Copy to clipboard");
    });
    it("should have clipboard text", () => {
      render( /*#__PURE__*/_jsx(CopyButton, {
        text: "test"
      }));
      expect(screen.getByTestId("stCopyButton")).toHaveAttribute("data-clipboard-text", "test");
    });
  });
