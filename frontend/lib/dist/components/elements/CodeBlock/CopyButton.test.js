...
describe("CopyButton Element", () => {
  ...
  it("renders without crashing", () => {
    render( /*#__PURE__*/_jsx(CopyButton, {
      text: "test"
    }));
  ...
  describe("attributes", () => {
    it("should have title", () => {
      ...
      expect(screen.getByTestId("stCodeCopyButton")).toHaveAttribute("title", "Copy to clipboard");
    });
    it("should have clipboard text", () => {
      render( /*#__PURE__*/_jsx(CopyButton, {
        text: "test"
      }));
      expect(screen.getByTestId("stCodeCopyButton")).toHaveAttribute("data-clipboard-text", "test");
    });
  });
...
//# sourceMappingURL=CopyButton.test.js.map