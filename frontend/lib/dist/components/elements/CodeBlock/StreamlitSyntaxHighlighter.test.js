...
describe("CustomCodeTag Element", () => {
  ...
  it("should render as plaintext", () => {
    ...
    expect(baseElement.querySelector("pre code")?.outerHTML).toBe('<code class="language-plaintext" style="white-space: pre;"><span>import streamlit as st\n' + "</span>\n" + 'st.write("Hello")\n' + "</code>");
  });
  ...
  it("should render as python", () => {
    ...
    expect(baseElement.querySelector("pre code .token.string")?.innerHTML).toBe('"Hello"');
  });
});
