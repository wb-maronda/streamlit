...
import { getElementId } from "../../../util/utils";
import { convertKeyToClassName, getKeyFromId, isComponentStale, shouldComponentBeEnabled } from "./utils";
...
const ButtonGroup = /*#__PURE__*/React.lazy(() => import("../../widgets/ButtonGroup"));
...
const RawElementNodeRenderer = props => {
  ...
  switch (node.element.type) {
    ...
    case "buttonGroup":
      {
        const buttonGroupProto = node.element.buttonGroup;
...
const ElementNodeRenderer = props => {
  ...
  return /*#__PURE__*/_jsx(Maybe, {
    ...
    children: /*#__PURE__*/_jsx(StyledElementContainer, {
      className: classNames("stElementContainer", "element-container", convertKeyToClassName(userKey)),
