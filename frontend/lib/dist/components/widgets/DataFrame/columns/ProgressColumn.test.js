...
describe("ProgressColumn", () => {
  it("creates a valid column instance", () => {
    ...
    expect(mockCell.data?.value).toEqual(0.5);
    expect(mockCell.data?.label).toEqual("50.00%");
  });
  it("supports configuring min/max scale", () => {
    ...
    expect(mockCell.data?.value).toEqual(1);
    ...
    expect(mockCell1.data?.value).toEqual(50);
  ...
  it("correctly formats float values to percentage", () => {
    ...
    expect(mockCell.data?.min).toEqual(0);
    expect(mockCell.data?.max).toEqual(1);
    expect(mockCell.data?.step).toEqual(0.01);
    // Correctly formats float values to percentage:
    expect(mockCell.data?.value).toEqual(0.52356);
    expect(mockCell.data?.label).toEqual("52.36%");
  });
  it("correctly formats int values to percentage", () => {
    ...
    expect(mockCell.data?.min).toEqual(0);
    expect(mockCell.data?.max).toEqual(100);
    expect(mockCell.data?.step).toEqual(1);
    // Correctly formats int values to percentage:
    expect(mockCell.data?.value).toEqual(52);
    expect(mockCell.data?.label).toEqual(" 52%");
  });
});
