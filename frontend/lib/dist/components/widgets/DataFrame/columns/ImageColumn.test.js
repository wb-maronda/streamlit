...
describe("ImageColumn", () => {
  it("creates a valid column instance", () => {
    ...
    const mockCell = mockColumn.getCell("https://streamlit.io/images/brand/streamlit-logo-primary-colormark-darktext.png");
    expect(mockCell.kind).toEqual(GridCellKind.Image);
    expect(mockCell.contentAlign).toEqual("center");
    expect(mockCell.data).toEqual(["https://streamlit.io/images/brand/streamlit-logo-primary-colormark-darktext.png"]);
  });
  ...
  ["https://streamlit.io/images/brand/streamlit-logo-primary-colormark-darktext.png", "https://streamlit.io/images/brand/streamlit-logo-primary-colormark-darktext.png"], ["/foo", "/foo"], ["", ""], [[], ""], ["data:image/png;base64,iVBORw0KGgoAAAAAAAAyCAYAAAAUYybjAAAgAElE...", "data:image/png;base64,iVBORw0KGgoAAAAAAAAyCAYAAAAUYybjAAAgAElE..."], [null, null], [undefined, null]])("supports string-compatible value (%p parsed as %p)", (input, value) => {
    const mockColumn = ImageColumn(MOCK_IMAGE_COLUMN_PROPS);
    const cell = mockColumn.getCell(input);
    expect(mockColumn.getCellValue(cell)).toEqual(value);
  });
});
//# sourceMappingURL=ImageColumn.test.js.map