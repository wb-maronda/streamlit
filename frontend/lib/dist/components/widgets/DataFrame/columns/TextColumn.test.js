...
describe("TextColumn", () => {
  it("creates a valid column instance", () => {
    ...
    expect(mockCell.data).toEqual("foo");
  });
  it.each([["foo", "foo"], ["abc def 1234 $", "abc def 1234 $"], [1, "1"], [0, "0"], [0.123, "0.123"], ["", ""], [[], ""], [["foo", "bar"], "foo,bar"], [[1, 2, 0.1231], "1,2,0.1231"], [true, "true"], [{
    foo: "bar"
  }, "[object Object]"], [null, null], [undefined, null]])("supports string-compatible value (%p parsed as %p)", (input, value) => {
    const mockColumn = TextColumn(MOCK_TEXT_COLUMN_PROPS);
  ...
  it("applies input validation in the getCell call based on max_chars and validate regex", () => {
    ...
    expect(mockColumn.getCell("abcdef", true).data).toBe("abcde");
...
//# sourceMappingURL=TextColumn.test.js.map