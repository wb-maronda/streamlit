...
describe("ListColumn", () => {
  it("creates a valid column instance", () => {
    ...
    expect(mockCell.data).toEqual(["foo", "bar"]);
  });
  ...
  [null, null], [undefined, null], ["", []], [[], []], ["[]", []], ["foo", ["foo"]],
  // Comma separated syntax
  ["foo,bar", ["foo", "bar"]], ["foo,bar,", ["foo", "bar", ""]], ["foo,bar,,", ["foo", "bar", "", ""]],
  // JSON Array syntax
  ["[\"foo\",\"bar\"]", ["foo", "bar"]],
  // non-string values
  [0, [0]], [1, [1]], [[0, 1.2], [0, 1.2]], [true, [true]], [false, [false]], [[true, false], [true, false]]])("supports array-compatible value (%p parsed as %p)", (input, value) => {
    const mockColumn = ListColumn(MOCK_LIST_COLUMN_PROPS);
    const cell = mockColumn.getCell(input);
    expect(mockColumn.getCellValue(cell)).toEqual(value);
  });
  it.each([[null, ""], [undefined, ""], [[], ""], [["foo", "bar"], "foo,bar"], [["foo", "bar", ""], "foo,bar,"], [["foo", "comma,in value"], "foo,comma in value"], [[0, 1.2], "0,1.2"], [[true, false], "true,false"]])("correctly prepares data for copy (%p parsed as %p)", (input, copyData) => {
    const mockColumn = ListColumn(MOCK_LIST_COLUMN_PROPS);
    const cell = mockColumn.getCell(input);
    expect(cell.copyData).toEqual(copyData);
  });
});
//# sourceMappingURL=ListColumn.test.js.map