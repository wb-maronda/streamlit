...
describe("ObjectColumn", () => {
  ...
  it("ignores isEditable configuration", () => {
    ...
    expect(mockColumn.getCell("foo").readonly).toEqual(true);
  });
  it.each([
  // Object column supports the
  // same conversions as the text column:
  ["foo", "foo"], ["abc def 1234 $", "abc def 1234 $"], [1, "1"], [0, "0"], [0.123, "0.123"], ["", ""], [[], ""], [["foo", "bar"], "foo,bar"], [[1, 2, 0.1231], "1,2,0.1231"], [true, "true"], [{
    foo: "bar"
...
//# sourceMappingURL=ObjectColumn.test.js.map