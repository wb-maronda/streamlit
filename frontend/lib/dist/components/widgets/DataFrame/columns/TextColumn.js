...
import { getErrorCell, removeLineBreaks, toSafeString } from "./utils";
/**
  ...
  return {
    ...
    getCell(data, validate) {
      ...
      try {
        ...
        return getErrorCell("Incompatible value", `The value cannot be interpreted as string. Error: ${error}`);
      }
    },
    getCellValue(cell) {
