...
describe("NumberInput widget", () => {
  ...
  describe("FloatData", () => {
    ...
    it("sets widget value on mount", () => {
      ...
      expect(props.widgetMgr.setDoubleValue).toHaveBeenCalledWith(props.element, props.element.default, {
        fromUi: false
      }, undefined);
    });
  ...
  describe("Step", () => {
    ...
    it("hides stepUp and stepDown buttons when width is smaller than 120px", () => {
      ...
      expect(screen.queryByTestId("stNumberInput-StepUp")).not.toBeInTheDocument();
      expect(screen.queryByTestId("stNumberInput-StepDown")).not.toBeInTheDocument();
    });
