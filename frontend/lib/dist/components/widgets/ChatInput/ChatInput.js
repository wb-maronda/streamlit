...
import { StyledChatInputContainer, StyledChatInput, StyledInputInstructionsContainer, StyledSendIconButton, StyledSendIconButtonContainer } from "./styled-components";
...
function ChatInput(_ref) {
  ...
  return /*#__PURE__*/_jsx(StyledChatInputContainer, {
    ...
    children: /*#__PURE__*/_jsxs(StyledChatInput, {
        ...
        overrides: {
          ...
          Input: {
            ...
            style: {
              ...
              height: isInputExtended ? "".concat(scrollHeight + ROUNDING_OFFSET, "px") : "auto",
              maxHeight: maxHeight ? "".concat(maxHeight, "px") : "none",
              // Baseweb requires long-hand props, short-hand leads to weird bugs & warnings.
              paddingRight: "3rem",
      ...
      }), width > breakpoints.hideWidgetDetails && /*#__PURE__*/_jsx(StyledInputInstructionsContainer, {
