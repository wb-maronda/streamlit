  ...
  thumbValueAlignment() {
    ...
    if (sliderDiv && thumb1Div && thumb2Div && thumb1ValueDiv && thumb2ValueDiv) {
      ...
      if (thumb1Value.right + labelGap > thumb2Value.left) {
        ...
        if (moveLeft) {
          thumb1ValueDiv.style.right = `${thumb2Value.width + labelGap - (thumb2.right - thumb1.right)}px`;
        } else {
          thumb2ValueDiv.style.left = `${thumb1Value.width + labelGap - (thumb2.left - thumb1.left)}px`;
        }
      }
    }
  }
