...
describe("Slider widget", () => {
  ...
  describe("Single value", () => {
    ...
    it("has the correct value", () => {
      ...
      expect(slider).toHaveAttribute("aria-valuetext", `${props.element.default}`);
  ...
  describe("Range value", () => {
    ...
    it("has the correct value", () => {
      ...
      expect(sliders[0]).toHaveAttribute("aria-valuetext", `${props.element.default[0]}`);
      expect(sliders[0]).toHaveAttribute("aria-valuemin", `${props.element.min}`);
      expect(sliders[0]).toHaveAttribute("aria-valuemax", `${props.element.default[1]}`);

      // Second slider - min is the current value of first slider
      expect(sliders[1]).toHaveAttribute("aria-valuetext", `${props.element.default[1]}`);
      expect(sliders[1]).toHaveAttribute("aria-valuemin", `${props.element.default[0]}`);
      expect(sliders[1]).toHaveAttribute("aria-valuemax", `${props.element.max}`);
    });
