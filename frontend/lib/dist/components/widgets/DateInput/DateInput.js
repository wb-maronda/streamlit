  ...
  render() {
    ...
    return /*#__PURE__*/_jsxs("div", {
      ...
      children: [/*#__PURE__*/_jsx(WidgetLabel, {
        ...
        placeholder: isRange ? `${element.format} – ${element.format}` : element.format,
        disabled: disabled,
          ...
          Day: {
            style: _ref2 => {
              ...
              return {
                ...
                "::before": {
                  backgroundColor: $selected || $pseudoSelected || $pseudoHighlighted || $isHovered ? `${colors.secondaryBg} !important` : colors.transparent
                },
                "::after": {
