...
import { LabelVisibilityMessage as LabelVisibilityMessageProto, TimeInput as TimeInputProto } from "../../../proto";
...
describe("TimeInput widget", () => {
  it("renders without crashing", () => {
    ...
    render( /*#__PURE__*/_jsx(TimeInput, {
      ...props
    }));
  ...
  it("has correct className and style", () => {
    ...
    expect(timeInput).toHaveStyle("width: ".concat(props.width, "px"));
  });
  it("can be disabled", () => {
  ...
  it("has a 24 format", () => {
    ...
    const inputNode = screen.getByLabelText("Selected 12:45. Select a time, 24-hour format.");
  ...
  it("sets the widget value on change", () => {
    ...
    expect(props.widgetMgr.setStringValue).toHaveBeenLastCalledWith(props.element, "12:30", {
      fromUi: true
    }, undefined);
  ...
  it("resets its value when form is cleared", () => {
    ...
    expect(props.widgetMgr.setStringValue).toHaveBeenLastCalledWith(props.element, "13:15", {
      fromUi: true
    }, undefined);
