...
import { TextInput as TextInputProto, LabelVisibilityMessage as LabelVisibilityMessageProto } from "../../../proto";
...
describe("TextInput widget", () => {
  ...
  it("shows a label", () => {
    ...
    const widgetLabel = screen.getByText("".concat(props.element.label));
  ...
  it("has correct className and style", () => {
    ...
    expect(textInput).toHaveStyle("width: ".concat(props.width, "px"));
  });
  it("can be disabled", () => {
    const props = getProps({}, {
      disabled: true
