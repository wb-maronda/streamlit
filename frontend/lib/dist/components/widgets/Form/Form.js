...
export const MISSING_SUBMIT_BUTTON_WARNING = "**Missing Submit Button**" + "\n\nThis form has no submit button, which means that user interactions will " + "never be sent to your Streamlit app." + "\n\nTo create a submit button, use the `st.form_submit_button()` function." + "\n\nFor more information, refer to the " + "[documentation for forms](https://docs.streamlit.io/develop/api-reference/execution-flow/st.form).";
export function Form(props) {
  ...
  } else if (!hasSubmitButton && !showWarning && scriptRunState === ScriptRunState.NOT_RUNNING) {
    setShowWarning(true);
  }
  let submitWarning;
  if (showWarning) {
    submitWarning = /*#__PURE__*/_jsx(StyledErrorContainer, {
      children: /*#__PURE__*/_jsx(AlertElement, {
  ...
  return /*#__PURE__*/_jsxs(StyledForm, {
    border: border,
    "data-testid": "stForm",
    children: [children, submitWarning]
  });
}
