...
import { Modal as UIModal, ModalHeader as UIModalHeader, ModalBody as UIModalBody, ModalFooter as UIModalFooter } from "baseui/modal";
...
function Modal(props) {
  ...
  const defaultOverrides = {
    ...
    Close: {
      style: {
        top: "calc(".concat(spacing.twoXL, " + .375rem)"),
