...
import { BaseButtonKind, BaseButtonSize, StyledBorderlessIconButton, StyledIconButton, StyledLinkButton, StyledMinimalButton, StyledPrimaryButton, StyledSecondaryButton, StyledTertiaryButton, StyledPrimaryFormSubmitButton, StyledSecondaryFormSubmitButton, StyledHeaderButton, StyledHeaderNoPaddingButton, StyledElementToolbarButton } from "./styled-components";
...
function BaseButton(_ref) {
  ...
  return /*#__PURE__*/_jsx(ComponentType, {
    ...
    "data-testid": "baseButton-".concat(kind),
    children: children
  });
}
