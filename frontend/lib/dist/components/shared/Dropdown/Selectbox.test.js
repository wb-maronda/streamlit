...
import { Selectbox, fuzzyFilterSelectOptions } from "./Selectbox";
...
describe("Selectbox widget", () => {
  ...
  it("has correct className and style", () => {
    ...
    expect(selectbox).toHaveStyle("width: ".concat(props.width, "px"));
  });
  it("renders a label", () => {
    render( /*#__PURE__*/_jsx(Selectbox, {
      ...props
    }));
    expect(screen.getByTestId("stWidgetLabel")).toHaveTextContent("".concat(props.label));
  });
  ...
  it("fuzzy filters options correctly", () => {
    ...
    const options = [{
      label: "e2e/scripts/components_iframe.py",
      value: ""
    }, {
      label: "e2e/scripts/st_warning.py",
      value: ""
    }, {
      label: "e2e/scripts/st_container.py",
      value: ""
    }, {
      label: "e2e/scripts/st_dataframe_sort_column.py",
      value: ""
    }, {
      label: "e2e/scripts/app_hotkeys.py",
      value: ""
    }, {
      label: "e2e/scripts/st_info.py",
      value: ""
    }, {
      label: "e2e/scripts/st_echo.py",
      value: ""
    }, {
      label: "e2e/scripts/st_json.py",
      value: ""
    }, {
      label: "e2e/scripts/st_experimental_get_query_params.py",
      value: ""
    }, {
      label: "e2e/scripts/st_markdown.py",
      value: ""
    }, {
      label: "e2e/scripts/st_color_picker.py",
      value: ""
    }, {
      label: "e2e/scripts/st_expander.py",
      value: ""
    }];
    const results1 = fuzzyFilterSelectOptions(options, "esstm");
    expect(results1.map(it => it.label)).toEqual(["e2e/scripts/st_markdown.py", "e2e/scripts/st_dataframe_sort_column.py", "e2e/scripts/st_experimental_get_query_params.py", "e2e/scripts/components_iframe.py"]);
    const results2 = fuzzyFilterSelectOptions(options, "eseg");
    expect(results2.map(it => it.label)).toEqual(["e2e/scripts/st_experimental_get_query_params.py"]);
  });
  it("updates value if new value provided from parent", () => {
    ...
    rerender( /*#__PURE__*/_jsx(Selectbox, {
      ...props
    }));
    expect(screen.getByText(props.options[1])).toBeInTheDocument();
  });
