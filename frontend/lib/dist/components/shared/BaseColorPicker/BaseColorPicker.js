...
import { StyledChromePicker, StyledColorBlock, StyledColorPicker, StyledColorPreview, StyledColorValue } from "./styled-components";
...
class BaseColorPicker extends React.PureComponent {
  ...
  componentDidCatch(error) {
    if (error?.name === "SecurityError") {
      ...
      logWarning(`Swallowing ColorPicker SecurityError '${error.name}: ${error.message}'`);
