...
describe("ColorPicker widget", () => {
  ...
  it("should render a label in the title", () => {
    ...
    const widgetLabel = screen.queryByText("".concat(props.label));
  ...
  it("should have correct style", () => {
    ...
    const colorPicker = screen.getByTestId("stColorPicker");
    expect(colorPicker).toHaveStyle("width: ".concat(props.width, "px"));
  });
  ...
  it("should update the widget value when it's changed", () => {
    ...
    expect(colorBlock).toHaveStyle("background-color: ".concat(newColor));
  });
