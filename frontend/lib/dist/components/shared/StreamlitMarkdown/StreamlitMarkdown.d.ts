 ...
 */
export declare const CustomPreTag: FunctionComponent<React.PropsWithChildren<ReactMarkdownProps>>;
export declare function RenderedMarkdown({ allowHTML, source, overrideComponents, isLabel, disableLinks, }: Readonly<RenderedMarkdownProps>): ReactElement;
/**
