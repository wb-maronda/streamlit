...
import StreamlitMarkdown, { createAnchorFromText, CustomCodeTag, CustomPreTag, LinkWithTargetBlank } from "./StreamlitMarkdown";
...
describe("StreamlitMarkdown", () => {
  ...
  it("properly adds background colors", () => {
    ...
    const colorMapping = new Map([["red", redbg], ["blue", bluebg], ["green", greenbg], ["violet", violetbg], ["orange", orangebg], ["gray", graybg], ["grey", graybg], ["rainbow", `linear-gradient(to right, ${redbg}, ${orangebg}, ${yellowbg}, ${greenbg}, ${bluebg}, ${violetbg}, ${purplebg})`]]);
    colorMapping.forEach(function (style, color) {
...
describe("CustomPreTag", () => {
  it("should render without crashing", () => {
    const props = getCustomCodeTagProps();
    render( /*#__PURE__*/_jsx(CustomPreTag, {
      ...props
    }));
    ...
    expect(preTag).toHaveTextContent('import streamlit as st st.write("Hello")');
  });
});
