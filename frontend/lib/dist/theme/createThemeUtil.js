...
import { createTheme as createBaseTheme, lightThemePrimitives as lightBaseThemePrimitives } from "baseui";
...
export const createBaseThemePrimitives = (baseTheme, theme) => {
  const {
    colors,
    genericFonts
  } = theme;
  return {
    ...
    mono100: colors.bgColor,
    // Popup menu
    mono200: colors.secondaryBg,
    // Text input, text area, selectbox
    mono300: colors.lightGray,
    // Disabled widget background
    mono400: colors.lightGray,
    // Slider track
    mono500: colors.gray,
    // Clicked checkbox and radio
    mono600: colors.fadedText40,
    // Disabled widget text
    mono700: colors.gray,
    // Unselected checkbox and radio
    mono800: colors.bodyText,
    // Selectbox text
    mono900: colors.bodyText,
...
export const createThemeOverrides = theme => {
  const {
    inSidebar,
    colors,
    genericFonts,
  ...
  const widgetBackgroundColor = colors.widgetBackgroundColor ? colors.widgetBackgroundColor : colors.secondaryBg;
  ...
  const mainPaneSecondaryBgColor = inSidebar ? colors.bgColor : colors.secondaryBg;
  return {
    borders: {
    ...
    typography: {
      ...
      // Textinput, textarea, selectboxes
      font450: {
        ...fontStyles
      },
      // Radio
...
export const createBaseUiTheme = function (theme) {
  let primitives = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : lightBaseThemePrimitives;
  return createBaseTheme(createBaseThemePrimitives(primitives, theme), createThemeOverrides(theme));
};
//# sourceMappingURL=createThemeUtil.js.map