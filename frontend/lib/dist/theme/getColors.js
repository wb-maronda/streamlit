...
export const computeDerivedColors = genericColors => {
  const {
    bodyText,
    secondaryBg,
    bgColor
  ...
  const linkText = hasLightBg ? genericColors.blue : lighten(genericColors.blue, 0.2);
  ...
  const darkenedBgMix100 = hasLightBg ? darken(bgMix, 0.3) : lighten(bgMix, 0.6); // Icons.
