...
declare const _default: {
    ...
    sizes: {
        ...
        smallLogoHeight: string;
        defaultLogoHeight: string;
        largeLogoHeight: string;
        sliderThumb: string;
        wideSidePadding: string;
        headerDecorationHeight: string;
        appRunningMen: string;
        appStatusMaxWidth: string;
    };
    spacing: {
        halfSmFont: string;
