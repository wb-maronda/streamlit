...
import { AUTO_THEME_NAME, bgColorToBaseString, computeSpacingStyle, createEmotionTheme, createTheme, CUSTOM_THEME_NAME, fontEnumToString, fontToEnum, getCachedTheme, getDefaultTheme, getHostSpecifiedTheme, getSystemTheme, getWrappedHeadersStyle, hasLightBackgroundColor, isColor, isPresetTheme, removeCachedTheme, setCachedTheme, toThemeInput } from "./utils";
...
describe("theme overrides", () => {
  ...
  it("honors the window variables set", async () => {
    ...
    expect(module.getMergedLightTheme().emotion.colors.primary).toEqual("purple");
    expect(module.getMergedDarkTheme().emotion.colors.primary).toEqual("yellow");
  });
