...
export const fontSizes = {
  twoSm: "".concat(fontSizeTwoSmall, "px"),
  // Use px to force sm to be a round number.
  sm: "".concat(fontSizeSmall, "px"),
  // Use px to force sm to be a round number.
  md: "1rem",
  mdLg: "1.125rem",
  lg: "1.25rem",
  ...
  threeXL: "2.25rem",
  fourXL: "2.75rem",
  twoSmPx: fontSizeTwoSmall,
  // twoSm but as a number, in pixels
  smPx: fontSizeSmall,
  // sm but as a number, in pixels
