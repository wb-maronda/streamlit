...
import { breakpoints, colors, fonts, fontSizes, fontWeights, genericFonts, iconSizes, letterSpacings, lineHeights, radii, sizes, spacing, zIndices } from "../theme/primitives";
...
const baseuiMockTheme = createBaseUiTheme(emotionMockTheme, lightThemePrimitives);
