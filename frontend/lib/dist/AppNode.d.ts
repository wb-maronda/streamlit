...
export declare class BlockNode implements AppNode {
    ...
    readonly deltaMsgReceivedAt?: number;
    readonly activeScriptHash: string;
    constructor(activeScriptHash: string, children?: AppNode[], deltaBlock?: BlockProto, scriptRunId?: string, fragmentId?: string, deltaMsgReceivedAt?: number);
...
export declare class AppRoot {
     ...
     */
    static empty(mainScriptHash?: string, isInitialRender?: boolean, sidebarElements?: BlockNode | undefined, logo?: Logo | null): AppRoot;
    ...
    get logo(): Logo | null;
    appRootWithLogo(logo: Logo, metadata: LogoMetadata): AppRoot;
