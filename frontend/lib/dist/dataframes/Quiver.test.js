...
import { IndexTypeName, Quiver } from "./Quiver";
import {
// Types
CATEGORICAL, CATEGORICAL_COLUMN, DATE, DECIMAL, DICTIONARY, FLOAT64, INT64, INTERVAL_DATETIME64, INTERVAL_FLOAT64, INTERVAL_INT64, INTERVAL_UINT64, PERIOD, RANGE, UINT64, UNICODE, TIMEDELTA,
// Special cases
EMPTY, MULTI, STYLER, DISPLAY_VALUES, FEWER_COLUMNS, DIFFERENT_COLUMN_TYPES, CATEGORICAL_INTERVAL, NAMED_INDEX } from "../mocks/arrow";
describe("Quiver", () => {
  describe("Public methods", () => {
    ...
    describe("getCell", () => {
      ...
      it("throws an exception if column index is out of range", () => {
        expect(() => q.getCell(0, 5)).toThrow("Column index is out of range: 5");
      });
    });
    describe("getTypeName", () => {
      describe("uses numpy_type", () => {
        ...
        test("timedelta", () => {
          ...
          const q = new Quiver(mockElement);
          const firstColumnType = q.types.data[0];
          expect(Quiver.getTypeName(firstColumnType)).toEqual("timedelta64[ns]");
        });
        test("dictionary", () => {
          const mockElement = {
            data: DICTIONARY
        ...
        test("interval datetime64[ns]", () => {
          const mockElement = {
            data: INTERVAL_DATETIME64
          };
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual("interval[datetime64[ns], right]");
        });
        test("interval float64", () => {
          const mockElement = {
            data: INTERVAL_FLOAT64
          };
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual("interval[float64, right]");
        });
        test("interval int64", () => {
          const mockElement = {
            data: INTERVAL_INT64
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual("interval[int64, right]");
        });
        test("interval uint64", () => {
          const mockElement = {
            data: INTERVAL_UINT64
          };
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual("interval[uint64, right]");
        });
      });
      describe("uses pandas_type", () => {
        test("categorical", () => {
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.CategoricalIndex);
        });
        test("date", () => {
          const mockElement = {
            data: DATE
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.DatetimeIndex);
        });
        test("float64", () => {
          const mockElement = {
            data: FLOAT64
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.Float64Index);
        });
        test("int64", () => {
          const mockElement = {
            data: INT64
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.Int64Index);
        });
        test("range", () => {
          const mockElement = {
            data: RANGE
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.RangeIndex);
        });
        test("uint64", () => {
          const mockElement = {
            data: UINT64
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.UInt64Index);
        });
        test("unicode", () => {
          const mockElement = {
            data: UNICODE
          ...
          const q = new Quiver(mockElement);
          const indexType = q.types.index[0];
          expect(Quiver.getTypeName(indexType)).toEqual(IndexTypeName.UnicodeIndex);
        });
      });
    });
    describe("format", () => {
      ...
      test("bytes", () => {
        expect(Quiver.format(new Uint8Array([1, 2, 3]), {
          pandas_type: "bytes",
          numpy_type: "bytes"
        })).toEqual("1,2,3");
      });
      test("date", () => {
        expect(Quiver.format(new Date(Date.UTC(1970, 0, 1)), {
          pandas_type: "date",
          numpy_type: "object"
        })).toEqual("1970-01-01");
      });
      test("datetime", () => {
        expect(Quiver.format(0, {
      ...
      test("decimal", () => {
        ...
        expect(Quiver.format(cell1.content, cell1.contentType, cell1.field)).toEqual("1.1");
        const cell2 = q.getCell(2, 1);
        expect(Quiver.format(cell2.content, cell2.contentType, cell2.field)).toEqual("10000");
        const cell3 = q.getCell(1, 2);
        expect(Quiver.format(cell3.content, cell3.contentType, cell3.field)).toEqual("2.23");
        const cell4 = q.getCell(2, 2);
        expect(Quiver.format(cell4.content, cell4.contentType, cell4.field)).toEqual("-0.1");
      });
      test("timedelta", () => {
        const mockElement = {
          data: TIMEDELTA
        ...
        const q = new Quiver(mockElement);
        const cell1 = q.getCell(1, 1);
        expect(Quiver.format(cell1.content, cell1.contentType, cell1.field)).toEqual("a few seconds");
        const cell2 = q.getCell(2, 1);
        expect(Quiver.format(cell2.content, cell2.contentType, cell2.field)).toEqual("4 hours");
        const cell3 = q.getCell(1, 2);
        expect(Quiver.format(cell3.content, cell3.contentType, cell3.field)).toEqual("20 days");
        const cell4 = q.getCell(2, 2);
        expect(Quiver.format(cell4.content, cell4.contentType, cell4.field)).toEqual("2 hours");
      });
      test("dictionary", () => {
        const mockElement = {
          data: DICTIONARY
        ...
        expect(Quiver.format(content, contentType, field)).toEqual("{\"a\":1,\"b\":2}");
      });
      test("categorical interval", () => {
        const mockElement = {
          data: CATEGORICAL_INTERVAL
        };
        const q = new Quiver(mockElement);
        const {
          content,
        ...
        expect(Quiver.format(content, contentType, field)).toEqual("(23.535, 256.5]");
      });
      test("period", () => {
        const mockElement = {
          data: PERIOD
        ...
        for (let columnIndex = 1; columnIndex < columns; columnIndex++) {
          ...
          for (let rowIndex = 0; rowIndex < rows; rowIndex++) {
            const {
              ...
              contentType,
              field
            } = q.getCell(rowIndex, columnIndex);
      ...
      test("list[unicode]", () => {
        expect(Quiver.format(vectorFromArray(["foo", "bar", "baz"]), {
  ...
  describe("Display", () => {
    describe("Pandas index types", () => {
      test("categorical", () => {
        ...
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", BigInt(100)], ["bar", BigInt(200)]]);
      ...
      test("date", () => {
        ...
        const q = new Quiver(mockElement);
        expect(q.index).toEqual([vectorFromArray([978220800000, 1009756800000])]);
        expect(q.columns).toEqual([["2000-12-31 00:00:00", "2001-12-31 00:00:00"]]);
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("float64", () => {
        ...
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[1.2, 1.3], [1.4, 1.5]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("int64", () => {
        ...
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[BigInt(0), BigInt(1)], [BigInt(2), BigInt(3)]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("interval datetime64[ns]", () => {
        ...
        const q = new Quiver(mockElement);
        expect(q.index.toString()).toEqual('[{"left": 1483228800000, "right": 1483315200000},{"left": 1483315200000, "right": 1483401600000}]');
        expect(q.columns).toEqual([["(2017-01-01, 2017-01-02]", "(2017-01-02, 2017-01-03]"]]);
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", BigInt(100)], ["bar", BigInt(200)]]);
        expect(q.types).toEqual({
          index: [{
            pandas_type: "object",
      ...
      test("interval float64", () => {
        ...
        const q = new Quiver(mockElement);
        expect(q.index.toString()).toEqual('[{"left": 0, "right": 1.5},{"left": 1.5, "right": 3}]');
      ...
      test("interval int64", () => {
        ...
        const q = new Quiver(mockElement);
        expect(q.index.toString()).toEqual('[{"left": 0, "right": 1},{"left": 1, "right": 2}]');
      ...
      test("uint64", () => {
        ...
        expect(q.index).toEqual([vectorFromArray([BigInt(1), BigInt(2)])]);
        expect(q.columns).toEqual([["1", "2"]]);
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[BigInt(1), BigInt(2)], [BigInt(3), BigInt(4)]]);
        expect(q.types).toEqual({
          index: [{
    ...
    describe("Special cases", () => {
      ...
      test("multi-index", () => {
        ...
        const q = new Quiver(mockElement);
        expect(q.index).toEqual([vectorFromArray([BigInt(1), BigInt(2)]), vectorFromArray(["red", "blue"])]);
        expect(q.columns).toEqual([["1", "2"], ["red", "blue"]]);
        expect(q.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", "1"], ["bar", "2"]]);
        expect(q.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.Int64Index,
  ...
  describe("Add rows", () => {
    describe("Pandas index types", () => {
      test("categorical", () => {
        ...
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", BigInt(100)], ["bar", BigInt(200)], ["foo", BigInt(100)], ["bar", BigInt(200)]]);
      ...
      test("date", () => {
        ...
        const q = new Quiver(mockElement);
        const qq = q.addRows(q);
        expect(qq.index).toEqual([vectorFromArray([978220800000, 1009756800000, 978220800000, 1009756800000])]);
        expect(qq.columns).toEqual([["2000-12-31 00:00:00", "2001-12-31 00:00:00"]]);
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.DatetimeIndex,
            numpy_type: "datetime64[ns]",
      ...
      test("float64", () => {
        ...
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[1.2, 1.3], [1.4, 1.5], [1.2, 1.3], [1.4, 1.5]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.Float64Index,
            numpy_type: IndexTypeName.Float64Index,
      ...
      test("int64", () => {
        ...
        const q = new Quiver(mockElement);
        const qq = q.addRows(q);
        expect(qq.index).toEqual([vectorFromArray([BigInt(1), BigInt(2), BigInt(1), BigInt(2)])]);
        expect(qq.columns).toEqual([["1", "2"]]);
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[BigInt(0), BigInt(1)], [BigInt(2), BigInt(3)], [BigInt(0), BigInt(1)], [BigInt(2), BigInt(3)]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.Int64Index,
            numpy_type: IndexTypeName.Int64Index,
      ...
      test("interval datetime64[ns]", () => {
        ...
        const q = new Quiver(mockElement);
        const qq = q.addRows(q);
        expect(qq.index.toString()).toEqual('[{"left": 1483228800000, "right": 1483315200000},{"left": 1483315200000, "right": 1483401600000},{"left": 1483228800000, "right": 1483315200000},{"left": 1483315200000, "right": 1483401600000}]');
        expect(qq.columns).toEqual([["(2017-01-01, 2017-01-02]", "(2017-01-02, 2017-01-03]"]]);
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", BigInt(100)], ["bar", BigInt(200)], ["foo", BigInt(100)], ["bar", BigInt(200)]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: "object",
      ...
      test("interval float64", () => {
        ...
        const q = new Quiver(mockElement);
        const qq = q.addRows(q);
        expect(qq.index.toString()).toEqual('[{"left": 0, "right": 1.5},{"left": 1.5, "right": 3},{"left": 0, "right": 1.5},{"left": 1.5, "right": 3}]');
      ...
      test("interval int64", () => {
        ...
        const q = new Quiver(mockElement);
        const qq = q.addRows(q);
        expect(qq.index.toString()).toEqual('[{"left": 0, "right": 1},{"left": 1, "right": 2},{"left": 0, "right": 1},{"left": 1, "right": 2}]');
      ...
      test("range", () => {
        ...
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", "1"], ["bar", "2"], ["foo", "1"], ["bar", "2"]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.RangeIndex,
            numpy_type: IndexTypeName.RangeIndex,
      ...
      test("uint64", () => {
        ...
        expect(qq.index).toEqual([vectorFromArray([BigInt(1), BigInt(2), BigInt(1), BigInt(2)])]);
        expect(qq.columns).toEqual([["1", "2"]]);
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([[BigInt(1), BigInt(2)], [BigInt(3), BigInt(4)], [BigInt(1), BigInt(2)], [BigInt(3), BigInt(4)]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.UInt64Index,
            numpy_type: IndexTypeName.UInt64Index,
    ...
    describe("Special cases", () => {
      ...
      test("multi-index", () => {
        ...
        const q = new Quiver(mockElement);
        const qq = q.addRows(q);
        expect(qq.index).toEqual([vectorFromArray([BigInt(1), BigInt(2), BigInt(1), BigInt(2)]), vectorFromArray(["red", "blue", "red", "blue"])]);
        expect(qq.columns).toEqual([["1", "2"], ["red", "blue"]]);
        expect(qq.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", "1"], ["bar", "2"], ["foo", "1"], ["bar", "2"]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.Int64Index,
      ...
      test("DataFrames with different column types", () => {
        ...
        expect(q1q2.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo", "1"], ["bar", "2"], ["baz", "1"], ["qux", "2"]]);
      ...
      it("uses df1 columns if df2 has more columns than df1", () => {
        ...
        expect(q1q2.data.toArray().map(a => a === null || a === void 0 ? void 0 : a.toArray())).toEqual([["foo"], ["bar"], ["foo"], ["bar"]]);
        expect(q1q2.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.UnicodeIndex,
            numpy_type: "object",
...
//# sourceMappingURL=Quiver.test.js.map