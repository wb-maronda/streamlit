...
import { CATEGORICAL, CATEGORICAL_COLUMN, CATEGORICAL_INTERVAL, DATE, DECIMAL, DICTIONARY, DIFFERENT_COLUMN_TYPES, DISPLAY_VALUES, EMPTY, FEWER_COLUMNS, FLOAT64, INT64, INTERVAL_DATETIME64, INTERVAL_FLOAT64, INTERVAL_INT64, INTERVAL_UINT64, MULTI, NAMED_INDEX, PERIOD, RANGE, STYLER, TIMEDELTA, UINT64, UNICODE } from "../mocks/arrow";
describe("Quiver", () => {
  ...
  describe("Display", () => {
    describe("Pandas index types", () => {
      test("categorical", () => {
        ...
        expect(q.data.toArray().map(a => a?.toArray())).toEqual([["foo", BigInt(100)], ["bar", BigInt(200)]]);
      ...
      test("date", () => {
        ...
        expect(q.data.toArray().map(a => a?.toArray())).toEqual([[new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("float64", () => {
        ...
        expect(q.data.toArray().map(a => a?.toArray())).toEqual([[1.2, 1.3], [1.4, 1.5]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("int64", () => {
        ...
        expect(q.data.toArray().map(a => a?.toArray())).toEqual([[BigInt(0), BigInt(1)], [BigInt(2), BigInt(3)]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("range", () => {
        ...
        expect(q.data.toArray().map(a => a?.toArray())).toEqual([["foo", "1"], ["bar", "2"]]);
        expect(q.types).toEqual({
          index: [{
      ...
      test("uint64", () => {
        ...
        expect(q.index).toEqual([vectorFromArray([BigInt(1), BigInt(2)])]);
        expect(q.columns).toEqual([["1", "2"]]);
        expect(q.data.toArray().map(a => a?.toArray())).toEqual([[BigInt(1), BigInt(2)], [BigInt(3), BigInt(4)]]);
        expect(q.types).toEqual({
          index: [{
  ...
  describe("Add rows", () => {
    describe("Pandas index types", () => {
      test("categorical", () => {
        ...
        expect(qq.data.toArray().map(a => a?.toArray())).toEqual([["foo", BigInt(100)], ["bar", BigInt(200)], ["foo", BigInt(100)], ["bar", BigInt(200)]]);
      ...
      test("date", () => {
        ...
        expect(qq.data.toArray().map(a => a?.toArray())).toEqual([[new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()], [new Date("2020-01-02T00:00:00.000Z").getTime(), new Date("2020-10-20T00:00:00.000Z").getTime()]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.DatetimeIndex,
            numpy_type: "datetime64[ns]",
      ...
      test("float64", () => {
        ...
        expect(qq.data.toArray().map(a => a?.toArray())).toEqual([[1.2, 1.3], [1.4, 1.5], [1.2, 1.3], [1.4, 1.5]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.Float64Index,
            numpy_type: IndexTypeName.Float64Index,
      ...
      test("int64", () => {
        ...
        expect(qq.data.toArray().map(a => a?.toArray())).toEqual([[BigInt(0), BigInt(1)], [BigInt(2), BigInt(3)], [BigInt(0), BigInt(1)], [BigInt(2), BigInt(3)]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.Int64Index,
            numpy_type: IndexTypeName.Int64Index,
      ...
      test("range", () => {
        ...
        expect(qq.data.toArray().map(a => a?.toArray())).toEqual([["foo", "1"], ["bar", "2"], ["foo", "1"], ["bar", "2"]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.RangeIndex,
            numpy_type: IndexTypeName.RangeIndex,
      ...
      test("uint64", () => {
        ...
        expect(qq.index).toEqual([vectorFromArray([BigInt(1), BigInt(2), BigInt(1), BigInt(2)])]);
        expect(qq.columns).toEqual([["1", "2"]]);
        expect(qq.data.toArray().map(a => a?.toArray())).toEqual([[BigInt(1), BigInt(2)], [BigInt(3), BigInt(4)], [BigInt(1), BigInt(2)], [BigInt(3), BigInt(4)]]);
        expect(qq.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.UInt64Index,
            numpy_type: IndexTypeName.UInt64Index,
    ...
    describe("Special cases", () => {
      ...
      test("DataFrames with different column types", () => {
        ...
        expect(q1q2.data.toArray().map(a => a?.toArray())).toEqual([["foo", "1"], ["bar", "2"], ["baz", "1"], ["qux", "2"]]);
      ...
      it("uses df1 columns if df2 has more columns than df1", () => {
        ...
        expect(q1q2.data.toArray().map(a => a?.toArray())).toEqual([["foo"], ["bar"], ["foo"], ["bar"]]);
        expect(q1q2.types).toEqual({
          index: [{
            pandas_type: IndexTypeName.UnicodeIndex,
            numpy_type: "object",
