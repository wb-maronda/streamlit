 ...
 */
import { Dictionary, Field, Struct, StructRow, Table, Vector } from "apache-arrow";
import { immerable } from "immer";
import { IArrow } from "@streamlit/lib/src/proto";
/** Data types used by ArrowJS. */
export type DataType = null | boolean | number | string | Date | Int32Array | Uint8Array | Uint32Array | Vector | StructRow | Dictionary | Struct | bigint;
/**
...
type PeriodFrequency = SupportedPandasOffsetType | `${SupportedPandasOffsetType}-${string}`;
...
export declare class Quiver {
     ...
     */
    getCategoricalOptions(dataColumnIndex: number): string[] | undefined;
     ...
     */
    static convertToSeconds(value: number | bigint, unit: number): number;
    ...
    static formatPeriodType(duration: bigint, typeName: PeriodType): string;
