...
describe("useScrollAnimation", () => {
  ...
  it("should register and deregister the correct events", () => {
    ...
    expect(targetElement.addEventListener).toHaveBeenCalledWith("pointerdown", expect.any(Function), {
      passive: true
    });
    expect(targetElement.addEventListener).toHaveBeenCalledWith("wheel", expect.any(Function), {
      passive: true
    });
    unmount();
    ...
    expect(targetElement.removeEventListener).toHaveBeenCalledWith("pointerdown", expect.any(Function));
    expect(targetElement.removeEventListener).toHaveBeenCalledWith("wheel", expect.any(Function));
    jest.useRealTimers();
  });
...
//# sourceMappingURL=useScrollAnimation.test.js.map