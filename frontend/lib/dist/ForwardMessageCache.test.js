 ...
 */
function createForwardMsg(hash) {
  let cacheable = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
...
test("caches messages as a deep copy", async () => {
  var _getCachedMessage, _getCachedMessage$del, _getCachedMessage$del2, _getCachedMessage2, _getCachedMessage2$me;
  const {
    cache,
    getCachedMessage
  } = createCache();
  ...
  expect((_getCachedMessage = getCachedMessage("Cacheable")) === null || _getCachedMessage === void 0 ? void 0 : (_getCachedMessage$del = _getCachedMessage.delta) === null || _getCachedMessage$del === void 0 ? void 0 : (_getCachedMessage$del2 = _getCachedMessage$del.newElement) === null || _getCachedMessage$del2 === void 0 ? void 0 : _getCachedMessage$del2.text.body).toEqual("test");
  expect((_getCachedMessage2 = getCachedMessage("Cacheable")) === null || _getCachedMessage2 === void 0 ? void 0 : (_getCachedMessage2$me = _getCachedMessage2.metadata) === null || _getCachedMessage2$me === void 0 ? void 0 : _getCachedMessage2$me.deltaPath).toEqual([2]);
...
test("fetches uncached messages from server", async () => {
  ...
  mockFetchCachedForwardMsg.mockResolvedValue(new Uint8Array(ForwardMsg.encode(msg).finish()));
  ...
  await expect(cache.processMessagePayload(refMsg, encodedRefMsg)).resolves.toEqual(msg);
...
test("errors when uncached message is not on server", async () => {
  ...
  await expect(cache.processMessagePayload(refMsg, encodedRefMsg)).rejects.toThrow();
});
...
//# sourceMappingURL=ForwardMessageCache.test.js.map