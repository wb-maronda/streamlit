...
import { EMBED_QUERY_PARAM_KEY, EMBED_QUERY_PARAM_VALUES, LoadingScreenType, getCookie, getEmbedUrlParams, getLoadingScreenType, isEmbed, setCookie, preserveEmbedQueryParams, isColoredLineDisplayed, isToolbarDisplayed, isPaddingDisplayed, isScrollingHidden, isLightTheme, isDarkTheme, keysToSnakeCase } from "./utils";
describe("getCookie", () => {
  afterEach(() => {
