 ...
 */
import { Element, LabelVisibilityMessage as LabelVisibilityMessageProto } from "@streamlit/lib/src/proto";
/**
...
export declare const EMBED_HIDE_LOADING_SCREEN = "hide_loading_screen";
export declare const EMBED_SHOW_LOADING_SCREEN_V1 = "show_loading_screen_v1";
export declare const EMBED_SHOW_LOADING_SCREEN_V2 = "show_loading_screen_v2";
export declare const EMBED_QUERY_PARAM_VALUES: string[];
export declare enum LoadingScreenType {
    NONE = 0,
    V1 = 1,
    V2 = 2
}
 ...
 */
export declare function preserveEmbedQueryParams(): string;
/**
 ...
 */
export declare function isLightThemeInQueryParams(): boolean;
/**
 * Returns true if the URL parameters contain ?embed_options=dark_theme (case insensitive).
 */
export declare function isDarkThemeInQueryParams(): boolean;
/**
 ...
 */
export declare function getLoadingScreenType(): LoadingScreenType;
...
export declare function makeAppSkeletonElement(): Element;
/**
...
export declare function isValidElementId(elementId: string | undefined | null): boolean;
/**
 * If the element has a valid ID, returns it. Otherwise, returns undefined.
 */
export declare function getElementId(element: Element): string | undefined;
...
export declare function extractPageNameFromPathName(pathname: string, basePath: string): string;
/**
